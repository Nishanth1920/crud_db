...
<div class="container" style="margin-top: 20px; width: 40%; ">
    <div ><h3 style="margin-bottom: 20px; margin-top: 20px;" class="px-3">CRUD OPERATION-ADD USER</h3></div>
        <div class="card">
            <div class="card-body">
                <form method="POST" action="add_user.php"> <!-- Change action to your PHP script -->
                    ...
                    <div class="mb-3">
                        <label for="name" class="form-label"><h6>Country</h6></label>
